...
const ROLES = [
  ...
  },
  {
    ...
    type: "Volunteer · Remote",
    tags: ["Arduino", "MyoWare", "Embedded C"],
    ...
    <div style={{ minHeight: "100vh", background: "var(--bg)", overflow: "hidden" }}>
      ...
      <section style={{
        ...
        <div style={{ maxWidth: 860, margin: "0 auto", position: "relative", zIndex: 1, width: "100%" }}>
          ...
          <h1 style={{
            fontSize: "clamp(40px, 6vw, 76px)", fontWeight: 600,
          ...
          <p style={{
            ...
            myojam is a student-led open-source project turning surface EMG signals
            into assistive computer control. We're looking for contributors who want
            to build technology that genuinely matters.
          </p>
      ...
      <section style={{ background: "var(--bg-secondary)", borderTop: "1px solid var(--border)", padding: "80px 32px" }}>
        <div style={{ maxWidth: 860, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 56 }}>
            ...
            <h2 style={{ fontSize: "clamp(28px, 4vw, 42px)", fontWeight: 600, letterSpacing: "-1px", color: "var(--text)" }}>
              Why myojam?
            </h2>
          </div>
            ...
            {REASONS.map((r, i) => (
              <div
                ...
                style={{
                  ...
                  opacity: visible[`reason_${i}`] ? 1 : 0,
                  transform: visible[`reason_${i}`] ? "translateY(0)" : "translateY(20px)",
      ...
      <section id="roles" style={{ padding: "80px 32px" }}>
        <div style={{ maxWidth: 860, margin: "0 auto" }}>
          <div style={{ marginBottom: 48 }}>
            ...
            <h2 style={{ fontSize: "clamp(28px, 4vw, 42px)", fontWeight: 600, letterSpacing: "-1px", color: "var(--text)", marginBottom: 16 }}>
              Where you fit in.
            </h2>
            <p style={{ fontSize: 16, color: "var(--text-secondary)", fontWeight: 300, lineHeight: 1.7, maxWidth: 520 }}>
              All roles are volunteer and remote. This is a portfolio-building, mission-driven
              project — not a job. But the work is real and the impact is real.
            </p>
          </div>
            ...
            {ROLES.map((role, i) => (
              <div
                ...
                style={{
                  ...
                  transform: visible[`role_${i}`] ? "translateY(0)" : "translateY(20px)",
              ...
              >
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 16, flexWrap: "wrap" }}>
                  <div style={{ flex: 1 }}>
                    ...
                    <p style={{ fontSize: 14, color: "var(--text-secondary)", lineHeight: 1.7, fontWeight: 300, marginBottom: 14 }}>{role.desc}</p>
                    <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
                      {role.tags.map(tag => (
                        <span key={tag} style={{
                          fontSize: 12, color: "var(--text-secondary)",
                          background: "var(--bg)", border: "1px solid var(--border-mid)",
                          borderRadius: 100, padding: "3px 12px", fontWeight: 400
                        }}>{tag}</span>
                      ))}
                    </div>
                  </div>
          ...
          <div
            ref={ref("form")}
            style={{
              opacity: visible["form"] ? 1 : 0,
              transform: visible["form"] ? "translateY(0)" : "translateY(20px)",
              transition: "opacity 0.6s ease, transform 0.6s ease"
            }}
          >
            <div style={{ marginBottom: 24 }}>
              <h3 style={{ fontSize: 22, fontWeight: 600, color: "var(--text)", letterSpacing: "-0.4px", marginBottom: 8 }}>
                Apply to contribute
              </h3>
              <p style={{ fontSize: 14, color: "var(--text-secondary)", fontWeight: 300, lineHeight: 1.7 }}>
                Tell us about yourself, what role interests you, and what you'd like to build.
            ...
            <div style={{
              ...
              <iframe
                src="https://tally.so/embed/CAREERS_FORM_ID?alignLeft=1&hideTitle=1&transparentBackground=1&dynamicHeight=1"
                width="100%"
                height="600"
                frameBorder="0"
