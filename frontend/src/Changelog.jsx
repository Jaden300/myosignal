...
const LOGS = [
  ...
  },
  {
    ...
    entries: [
      ...
      { type:"milestone", text:"Blog - Instagram-style news and EMG fact posts with carousel lightbox" },
        ...
        <Reveal>
          <div style={{ marginTop:16, background:"linear-gradient(135deg, rgba(255,45,120,0.05) 0%, transparent 100%)", border:"1px solid rgba(255,45,120,0.15)", borderRadius:"var(--radius)", padding:"40px" }}>
            ...
            <div style={{ display:"flex", flexDirection:"column", gap:10 }}>
              {[
                ["More lesson plans - signal processing deep dive and a cross-curricular unit on assistive technology design"],
                ["Community dataset - open call for EMG recordings to build a more demographically diverse training set"],
                ["Translated content - lesson plans and key articles in Spanish and French"],
                ["Article submission pipeline - community-contributed articles with editorial review"],
                ["Educator collaboration network - a way for teachers using myojam to share adaptations and feedback"],
              ].map(([text], i) => (
